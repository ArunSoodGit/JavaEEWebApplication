...
<div class="row justify-content-md-center mt-5"  >
    <form method="post " name="loginForm" action="j_security_check" >
        <div class="form-group">
            ...
            <input type="login" class="form-control" id="login" name="j_username" aria-describedby="emailHelp" placeholder=" Login">

        </div>
        <div class="form-group">
            <label for="password">Hasło</label>
            <input type="password" class="form-control" name="j_password" id="password" placeholder="Hasło">
        </div>
